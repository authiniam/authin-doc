...
<h3 dir="rtl">راهنمای اتصال به سامانه‌ی احراز هویت مرکزی از طریق پروتکل‌های OAuth 2.0 و OpenID Connect:</h3>
</br>
  ...
  <li><a href="#resource_owner_password_flow">Resource Owner Password Flow</a></li>      
    <li><a href="#token_validation">اصالت‌سنجی توکن (Token Validation)</a>
        <ul>
            ...
            <li><a href="#token_signature_validation">اصالت‌سنجی امضای دیجیتال</a></li>
            <li><a href="#token_claim_validation">اصالت‌سنجی claimهای استاندارد</a></li>
            <li><a href="#access_token_validation">اصالت‌سنجی Access Token</a></li>
            <li><a href="#id_token_validation">اصالت‌سنجی ID Token</a></li>
            <li><a href="#logout_token_validation">اصالت‌سنجی Logout Token</a></li>
        </ul>
    </li>
	<li><a href="#user_info">درخواست UserInfo</a></li>
    <li><a href="#refresh_token">به روز رسانی توکن (Refresh Token)</a></li>
    <li><a href="#op_initiated_logout">OP-Initiated Logout:</a>
        <ul dir="rtl">
            <li><a href="#op_initiated_backchannel_logout">Back-Channel Logout</a></li>
            <li><a href="#op_initiated_frontchannel_logout">Front-Channel Logout</a></li>
        </ul>
    </li>
    <li><a href="#rp_initiated_logout">RP-Initiated Logout</a></li>
<ul>	
</br>

<h2 id="authorization_code_flow" dir="rtl">Authorization Code Flow:</h2>
...
<h2 id="pkce_flow" dir="rtl">PKCE Flow:</h2>
...
<h2 id="resource_owner_password_flow" dir="rtl">Resource Owner Password Flow:</h2>
...
<h3 id="token_structure_validation" dir="rtl">اصالت‌سنجی ساختار:</h3>
...
<h3 id="token_signature_validation" dir="rtl">اصالت‌سنجی امضای دیجیتال:</h3>
...
<h3 id="token_claim_validation" dir="rtl">اصالت‌سنجی claimهای استاندارد:</h3>
...
<h3 id="access_token_validation" dir="rtl">اصالت‌سنجی Access Token:</h3>
...
<h3 id="id_token_validation" dir="rtl">اصالت‌سنجی ID Token:</h3>
...
<h3 id="logout_token_validation" dir="rtl">اصالت‌سنجی Logout Token:</h3>
...
<h2 id="user_info" dir="rtl">درخواست UserInfo:</h2>
...
<h2 id="refresh_token" dir="rtl">به روز رسانی توکن (Refresh Token):</h2>
...
<h2 id="op_initiated_logout" dir="rtl">OP-Initiated Logout:</h2>

<h3 id="op_initiated_backchannel_logout" dir="rtl">Back-Channel Logout:</h3>
...
<h3 id="op_initiated_frontchannel_logout" dir="rtl">Front-Channel Logout:</h3>
...
<h2 id="rp_initiated_logout" dir="rtl">RP-Initiated Logout:</h2>
